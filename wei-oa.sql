/*
 ...
 Source Schema         : wei-oa

 Target Server Type    : MySQL
 Target Server Version : 80019
 File Encoding         : 65001

 Date: 19/10/2021 13:37:21
*/
...
CREATE TABLE `adm_leave_form`  (
  ...
  `state` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'processing-正在审批 approved审批已通过 refused-审批被驳回',
...
-- ----------------------------
INSERT INTO `adm_leave_form` VALUES (1, 4, 2, '2021-10-18 00:00:00', '2021-10-24 00:00:00', '病假不舒服', '2021-10-17 13:37:44', 'approved');
...
CREATE TABLE `adm_process_flow`  (
  `process_id` bigint NOT NULL AUTO_INCREMENT COMMENT '任务处理编号',
  ...
  `is_last` tinyint NOT NULL COMMENT '是否是最后节点 0-否 1-是',
...
-- ----------------------------
INSERT INTO `adm_process_flow` VALUES (1, 1, 4, 'apply', NULL, NULL, '2021-10-17 13:37:44', NULL, 1, 'complete', 0);
INSERT INTO `adm_process_flow` VALUES (2, 1, 2, 'audit', 'approved', '', '2021-10-17 13:37:44', '2021-10-17 13:39:14', 2, 'complete', 0);
INSERT INTO `adm_process_flow` VALUES (3, 1, 1, 'audit', 'approved', 'ad', '2021-10-17 13:37:44', '2021-10-17 13:41:22', 3, 'complete', 1);
...
CREATE TABLE `sys_node`  (
  ...
  `node_type` int NOT NULL COMMENT '节点类型1-模块 2-功能',
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (1, 4, '您的请假申请[2021-10-18-00-2021-10-24-00]已提交，请等待上级审批', '2021-10-17 13:37:44');
INSERT INTO `sys_notice` VALUES (2, 2, '研发工程师-宋彩妮提起请假申请[2021-10-18-00-2021-10-24-00],请尽快审批', '2021-10-17 13:37:44');
INSERT INTO `sys_notice` VALUES (3, 4, '您的请假申请[2021-10-18-00-2021-10-24-00]部门经理齐紫陌已批准,审批意见: ,请继续等待上级审批', '2021-10-17 13:39:14');
INSERT INTO `sys_notice` VALUES (4, 1, '研发工程师-宋彩妮提起请假申请[2021-10-18-00-2021-10-24-00],请尽快审批', '2021-10-17 13:39:14');
INSERT INTO `sys_notice` VALUES (5, 2, '研发工程师-宋彩妮提起请假申请[2021-10-18-00-2021-10-24-00]您已批准,审批意见:,申请转至上级领导继续审批', '2021-10-17 13:39:14');
INSERT INTO `sys_notice` VALUES (6, 4, '您的请假申请[2021-10-18-00-2021-10-24-00]总经理张晓涛已批准,审批意见:ad,审批流程已结束', '2021-10-17 13:41:22');
INSERT INTO `sys_notice` VALUES (7, 1, '研发工程师-宋彩妮提请的请假申请[2021-10-18-00-2021-10-24-00]您已批准,审批意见:ad,审批结束', '2021-10-17 13:41:22');
